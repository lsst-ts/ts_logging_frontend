...
import LinkIcon from "../assets/LinkIconBlack.svg";
    ...
    <Table className="table-auto md:table-fixed w-auto">
      <TableHeader>
        <TableRow>
          ...
          <TableHead
            colSpan={2}
            className="sticky top-0 z-10 !text-black text-lg"
          >
            Summary
          </TableHead>
          <TableHead className="sticky top-0 z-10 !text-black text-lg">
          ...
          <TableHead className="sticky top-0 z-10 !text-black text-lg min-w-[9em]">
            Created
          </TableHead>
          <TableHead className="sticky top-0 z-10 !text-black text-lg min-w-[9em]">
            Last Updated
