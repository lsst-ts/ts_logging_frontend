          ...
          <>
            ...
            <Popover>
              ...
              <PopoverContent className="bg-black text-white text-sm border-yellow-700 w-[400px]">
                ...
                <p>
                  <strong>Not Exposures:</strong> Observable time - Exposure
                  Time
                </p>
                <div>
                  <ul className="p-2 list-inside list-disc">
                    <li>
                      <strong>Gaps:</strong> Inter-exposure time between
                      exposures (includes readout & slew)
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      <br />
                      (Observable time - exposure time - overhead time - time
                      loss to weather)
                    </li>
                    <li>
                      <strong>Closed Dome:</strong> Time where the dome was
                      closed during the night so far(from ~50%{" "}
