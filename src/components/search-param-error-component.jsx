  ...
  return (
    <div className="h-screen w-full flex items-center justify-center px-4">
      <div className="max-w-md text-center text-white space-y-4">
        ...
        <h2 className="text-2xl font-bold">Invalid URL Parameters</h2>
        ...
        <div className="flex justify-center">
          <Button
            className="bg-white text-black mt-4 w-[150px] h-10 font-normal rounded-xs border border-1 shadow-[4px_4px_4px_0px_#3CAE3F] 
                      flex justify-center items-center p-2 
                      hover:shadow-[6px_6px_8px_0px_#3CAE3F] hover:scale-[1.02] hover:bg-white transition-all duration-200"
            onClick={() => (window.location.href = "/nightlydigest/")}
          >
            Default View
          </Button>
        </div>
