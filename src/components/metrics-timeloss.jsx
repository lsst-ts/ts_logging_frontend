  ...
  return (
    <div className="bg-teal-900 drop-shadow-sky-700 drop-shadow-lg text-white p-2">
      ...
      <div className="absolute right-3 top-2">
        ...
        >
          <g clipPath="url(#clip0_576_2042)">
            ...
            <path
              d="M16.6333 20.5L18.6333 32.5"
              stroke="white"
              strokeLinecap="round"
            />
            <path
              d="M25.6333 32.5L27.6333 20.5"
              stroke="white"
              strokeLinecap="round"
            />
            <g clipPath="url(#clip1_576_2042)">
              ...
              />
              <path
                d="M22.1333 15L19.6333 12.5"
                stroke="white"
                strokeLinecap="round"
              />
              <path
                d="M22.1333 15L26.1333 11"
                stroke="white"
                strokeLinecap="round"
              />
            </g>
            ...
            <mask id="path-12-inside-2_576_2042" fill="white">
              <path d="M7.18021 8.78251C6.98495 8.58725 6.98495 8.27066 7.18021 8.0754L11.4229 3.83276C11.6181 3.6375 11.9347 3.6375 12.13 3.83276L14.3181 6.02088L9.36833 10.9706L7.18021 8.78251Z" />
            </mask>
            <path
              ...
              stroke="white"
              strokeWidth="2"
              mask="url(#path-12-inside-2_576_2042)"
            />
          </g>
          <defs>
      ...
      <div className="text-sm font-light">
        ({weatherPercentage}% weather; {faultPercentage}% fault)
      </div>
    </div>
  );
}
