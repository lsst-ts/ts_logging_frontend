          ...
          <>
            ...
            <Popover>
              ...
              <PopoverContent className="bg-black text-white text-sm border-yellow-700">
                ...
                display detailed information on the data displayed in this
                Applet, instructions on how to use any controls, and where the
                user will be taken if they click on certain linked sections of
                the Applet.
              </PopoverContent>
            </Popover>
          </>
