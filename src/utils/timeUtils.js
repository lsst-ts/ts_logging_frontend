...
/**
 * Returns the current dayobs as a formatted dayobs integer.
 *
 * @param {string} [format="yyyyLLdd"] - The format string (e.g., "yyyy-LL-dd"
 * or "yyyyLLdd"). See https://moment.github.io/luxon/#/formatting?id=table-of-tokens.
 * @returns {number} The current dayobs, as a formatted integer.
 */
