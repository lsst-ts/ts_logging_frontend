...
const queryParams = "?startDayobs=20251210&endDayobs=20251214";
...
test.describe("Nightly Digest Dashboard page", () => {
  const url = `${NIGHTLY_DIGEST_URL}/${queryParams}`;
...
test.describe("Nightly Digest Plots page", () => {
  const url = `${NIGHTLY_DIGEST_URL}/plots${queryParams}`;
...
test.describe("Nightly Digest Datalog page", () => {
  const url = `${NIGHTLY_DIGEST_URL}/data-log${queryParams}`;
...
test.describe("Nightly Digest Context Feed page", () => {
  const url = `${NIGHTLY_DIGEST_URL}/context-feed${queryParams}`;
...
test.describe("Nightly Digest Visit Maps page", () => {
  const url = `${NIGHTLY_DIGEST_URL}/visit-maps${queryParams}`;
