...
//
// TAI equivalents (UTC ms + 37 000):
const TWILIGHT_EVENING_TAI = new Date("2026-01-01T20:00:00Z").getTime() + 37000; // 1767297637000
const TWILIGHT_MORNING_TAI = new Date("2026-01-02T04:00:00Z").getTime() + 37000; // 1767326437000
const MOON_RISE_TAI = new Date("2026-01-01T22:00:00Z").getTime() + 37000; // 1767304837000
