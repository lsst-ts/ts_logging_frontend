...
- Fix JiraTicketsTable size in big screens. (`OSW-1344 <https://rubinobs.atlassian.net//browse/OSW-1344>`_)
...
- Fixed an issue where timeline shift-click selection extension failed without mouse movement. (`OSW-1835 <https://rubinobs.atlassian.net//browse/OSW-1835>`_)
